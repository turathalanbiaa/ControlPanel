...
@php $subCourses = $courses->filter(function ($course){return ($course->Level == \App\Model\Student\Level::SETOH_BEGINNER_PART_ONE);}); @endphp
<h3 class="ui center aligned orange header">{{\App\Model\Student\Level::getLevelName(\App\Model\Student\Level::SETOH_BEGINNER_PART_ONE)}}</h3>
<table class="ui right aligned orange table">
    <thead>
    <tr>
        <th>ID</th>
...
@php $subCourses = $courses->filter(function ($course){return ($course->Level == \App\Model\Student\Level::SETOH_BEGINNER_PART_TWO);}); @endphp
<h3 class="ui center aligned orange header">{{\App\Model\Student\Level::getLevelName(\App\Model\Student\Level::SETOH_BEGINNER_PART_TWO)}}</h3>
<table class="ui right aligned orange table">
    <thead>
    <tr>
        <th>ID</th>
